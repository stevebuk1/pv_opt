...
| Optimise Discharging Fill First     | `on`/`off` | `switch.pvopt_fill_first`           |   Off   | Controls whether the app will fill the battery in cost effective slots prior to sseing if forced dischargeing will result in a cost saving. Filling first can offer a better cost saving than discharging alone when solar is low. Currently in Beta as a seperate mode.                                                                                                                                              |
